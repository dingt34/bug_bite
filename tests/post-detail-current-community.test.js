...
global.wx = { cloud: { callFunction: option => Promise.resolve({ result: { ok: true, data: { post: { _id: option.data.postId, author: '测试用户', text: '真实经历内容', imageFileIds: [], comments: 0, status: 'published' }, comments: [] } } }) }, showToast() {}, showModal() {}, navigateBack() {}, navigateTo() {} };
