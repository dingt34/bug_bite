...
console.log('🚀 开始测试：草稿和历史根据日期分类逻辑...');
...
pastDate.setDate(today.getDate() -147); // 7天前
...
console.log('   - 跳转到precheck-result（只读模式）');
console.log('');

console.log('2. 草稿页应包含：');
console.log('   • 下周海边度假');
console.log('   - 日期：', futureDateStr1, '（未来日期）');
console.log('   - 有precheckData，跳转到precheck（可编辑）');
console.log('');
console.log('   • 下月滑雪计划');
console.log('   - 日期：', futureDateStr2, '（未来日期）');
console.log('   - 有precheckData，跳转到precheck（可编辑）');
console.log('');
console.log('   • 新建周末游');
console.log('   - 日期：', futureDateStr1, '（未来日期）');
console.log('   - 无precheckData，跳转到precheck（空白表单）');
console.log('');
...
console.log('');
console.log('4. 测试"草稿"选项卡：');
console.log('   a) 应该看到3个行程');
console.log('   b) 测试删除功能：');
console.log('      - 点击垃圾桶图标删除"新建周末游"');
console.log('      - 确认删除后，行程应该消失');
console.log('   c) 测试跳转功能：');
console.log('      - 点击"下周海边度假" → 跳转到precheck页面');
console.log('      - 表单应该自动填充已有数据：目的地"三亚海滩"等');
console.log('      - 修改数据后保存');
console.log('      - 返回行程页面，再次点击同一行程');
console.log('      - 应该显示修改后的数据');
console.log('   d) 测试新建功能：');
...
console.log('');
console.log('🔧 技术实现要点：');
console.log('• my-plans.js：根据dateValue字段的日期值进行分类');
console.log('• precheck.js：generate函数不标记isCompleted');
console.log('• precheck-result.js：根据readonly参数控制编辑权限');
console.log('• 界面：草稿页添加删除按钮，历史页只读提示');