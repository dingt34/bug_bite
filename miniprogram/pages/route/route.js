...
Page({
  ...
  confirm(){store.set('routeDraft',{summary:`${this.data.end} ${this.data.mode==='ride'?'骑行':'徒步'}路线`,distance:this.data.distance,duration:this.data.duration,climb:this.data.climb});wx.navigateBack();}
});
